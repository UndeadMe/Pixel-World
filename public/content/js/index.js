...
searchSubmit.addEventListener("click", () => searchByHeading(API.order_by, 20, searchBar.value))
searchBar.addEventListener("keyup", (e) => { if (e.key === "Enter") searchByHeading(API.order_by, 20, searchBar.value) })